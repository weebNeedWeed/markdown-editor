...
#[function_component(CloudArrowUp)]
pub fn cloud_arrow_up(IconProps { class }: &IconProps) -> Html {
    html! {
        <Svg class={class.clone()}>
...
#[function_component(FiletypeMd)]
pub fn filetype_md(IconProps { class }: &IconProps) -> Html {
    html! {
        <Svg class={class.clone()}>
...
#[function_component(FiletypePdf)]
pub fn filetype_pdf(IconProps { class }: &IconProps) -> Html {
    html! {
        <Svg class={class.clone()}>
...
#[function_component(FiletypeHtml)]
pub fn filetype_html(IconProps { class }: &IconProps) -> Html {
    html! {
        <Svg class={class.clone()}>
...
#[function_component(Gear)]
pub fn gear(IconProps { class }: &IconProps) -> Html {
    html! {
        <Svg class={class.clone()}>
...
pub fn close(IconProps { class }: &IconProps) -> Html {
    html! {
        <Svg class={class.clone()}>
...
#[function_component(Arrow90DegLeft)]
pub fn arrow_90_deg_left(IconProps { class }: &IconProps) -> Html {
    html! {
        <Svg class={class.clone()}>
...
#[function_component(Arrow90DegRight)]
pub fn arrow_90_deg_right(IconProps { class }: &IconProps) -> Html {
    html! {
        <Svg class={class.clone()}>
...
#[function_component(ClockHistory)]
pub fn clock_history(IconProps { class }: &IconProps) -> Html {
    html! {
        <Svg class={class.clone()}>
...
pub fn file_text(IconProps { class }: &IconProps) -> Html {
    html! {
        <Svg class={class.clone()}>
...
#[function_component(ArrowBarLeft)]
pub fn arrow_bar_left(IconProps { class }: &IconProps) -> Html {
    html! {
        <Svg class={class.clone()}>
...
pub fn quote_icon(IconProps { class }: &IconProps) -> Html {
    html! {
        <Svg class={class.clone()}>
...
#[function_component(Link45Deg)]
pub fn link_45_deg(IconProps { class }: &IconProps) -> Html {
    html! {
        <Svg class={class.clone()}>
...
pub fn image_icon(IconProps { class }: &IconProps) -> Html {
    html! {
        <Svg class={class.clone()}>
...
pub fn table_icon(IconProps { class }: &IconProps) -> Html {
    html! {
        <Svg class={class.clone()}>
...
#[function_component(TypeStrikethrough)]
pub fn type_strikethrough(IconProps { class }: &IconProps) -> Html {
    html! {
        <Svg class={class.clone()}>
